...
class MultiModulesCodeGenTransform(project: Project) : HunterTransform(project) {
    ...
    override fun transform(
        ...
        this.bytecodeWeaver = MultiModulesByteCodeGenWeaver()
